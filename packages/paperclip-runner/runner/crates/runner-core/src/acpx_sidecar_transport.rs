...
fn response_error_classification(error: &ResponseError) -> &'static str {
    match error.code.as_str() {
        ...
        "ERR_INVALID_ARG_TYPE" => return "diagnostic_invalid_argument_type",
        "ERR_INVALID_ARG_VALUE" => return "diagnostic_invalid_argument_value",
        "ERR_OUT_OF_RANGE" => return "diagnostic_out_of_range",
        "ERR_STREAM_PREMATURE_CLOSE" => return "diagnostic_stream_premature_close",
        "ERR_STREAM_DESTROYED" => return "diagnostic_stream_destroyed",
        "ERR_STREAM_WRITE_AFTER_END" => return "diagnostic_stream_write_after_end",
        "EPIPE" => return "diagnostic_broken_pipe",
        "ECONNRESET" => return "diagnostic_connection_reset",
        "ENOENT" => return "diagnostic_file_not_found",
        "EACCES" => return "diagnostic_permission_denied",
        "EPERM" => return "diagnostic_operation_not_permitted",
        "EINVAL" => return "diagnostic_invalid_argument",
        "EMFILE" => return "diagnostic_process_file_limit",
        "ENFILE" => return "diagnostic_system_file_limit",
        "ABORT_ERR" => return "diagnostic_aborted",
        "ERR_ASSERTION" => return "diagnostic_assertion",
        "ERR_FD_RANGE" => return "diagnostic_fd_range",
        "ERR_MODULE_NOT_FOUND" => return "diagnostic_module_not_found",
        "ERR_UNKNOWN_FILE_EXTENSION" => return "diagnostic_unknown_file_extension",
